...
namespace lasd {
    ...
    template <typename Data> bool DictionaryContainer<Data>::InsertAll(const MappableContainer<Data>& source) noexcept {
    ...
    template <typename Data> bool DictionaryContainer<Data>::InsertAll(MutableMappableContainer<Data>&& source) noexcept {
        bool every_single_item_was_inserted = true;
        auto functor = [this](const Data& value, void* flag){ *((bool*)flag) &= this->Insert(value); };
        source.Fold(functor, &every_single_item_was_inserted);
        return every_single_item_was_inserted; 
    ...
    template <typename Data> bool DictionaryContainer<Data>::RemoveAll(const MappableContainer<Data>& source) noexcept {
    ...
    template <typename Data> bool DictionaryContainer<Data>::InsertSome(const MappableContainer<Data>& source) noexcept {
    ...
    template <typename Data> bool DictionaryContainer<Data>::InsertSome(MutableMappableContainer<Data>&& source) noexcept {
        bool at_least_one_item_was_inserted = false;
        auto functor = [this](const Data& value, void* flag){ *((bool*)flag) |= this->Insert(value); };
        source.Fold(functor, &at_least_one_item_was_inserted);
        return at_least_one_item_was_inserted;
    ...
    template <typename Data> bool DictionaryContainer<Data>::RemoveSome(const MappableContainer<Data>& source) noexcept {
